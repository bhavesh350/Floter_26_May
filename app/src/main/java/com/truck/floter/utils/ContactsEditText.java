...
/**
 * Created by SONI on 5/21/2017.
 */

public class ContactsEditText extends android.support.v7.widget.AppCompatMultiAutoCompleteTextView {
    ...
    private void init(Context context) {
        ...
        BitmapFactory.decodeResource(context.getResources(),
                R.drawable.seach_list_default_pic, options);
...
//            String number = getStringNumber(cursor.getString(ContactsQuery.DISPLAY_NAME_COLUMN));
