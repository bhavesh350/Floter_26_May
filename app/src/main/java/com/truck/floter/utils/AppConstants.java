...
public class AppConstants {
    ...
    public static String EXTRA_2 = "extra2";
    public static String FB_ID = "facebookId";
    public static String IS_LOGIN = "isLogged";
    public static String PASSWORD = "password";
    public static String PAYBLE_TRIP_ID = "paybleTripId";
