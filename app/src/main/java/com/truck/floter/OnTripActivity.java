...
import com.truck.floter.CustomActivity.ResponseCallback;
import com.truck.floter.application.MyApp;
import com.truck.floter.fragments.FragmentDrawer;
import com.truck.floter.fragments.FragmentDrawer.FragmentDrawerListener;
import com.truck.floter.model.Payment;
...
public class OnTripActivity extends CustomActivity implements ResponseCallback, FragmentDrawerListener, OnMapReadyCallback, OnConnectionFailedListener, LocationCallback, PermissionCallback {
    ...
    L_0x0012:
        ...
        r2 = (com.truck.floter.model.Trip) r2;	 Catch:{ JSONException -> 0x0090, Exception -> 0x0095 }
    ...
    L_0x004c:
        r3 = com.truck.floter.application.MyApp.getApplication();	 Catch:{ Exception -> 0x0097, JSONException -> 0x0090 }
    ...
    L_0x0060:
        ...
        r4 = com.truck.floter.model.TripStatus.Finished;	 Catch:{ JSONException -> 0x0090, Exception -> 0x0095 }
    ...
    L_0x0097:
        ...
        goto L_0x0060;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.truck.floter.OnTripActivity.onJsonObjectResponseReceived(org.json.JSONObject, int):void");
    }
