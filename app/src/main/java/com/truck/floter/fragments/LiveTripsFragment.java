package com.truck.floter.fragments;
...
import com.truck.floter.R;
import com.truck.floter.CancelTripActivity;
import com.truck.floter.MainActivity;
import com.truck.floter.application.MyApp;
import com.truck.floter.fragments.CustomFragment.ResponseCallback;
import com.truck.floter.model.Trip;
import com.truck.floter.model.TripStatus;
import com.truck.floter.utils.AppConstants;
import com.truck.floter.utils.LocationProvider;
import com.truck.floter.utils.LocationProvider.LocationCallback;
import com.truck.floter.utils.LocationProvider.PermissionCallback;
...
//        getView().getViewTreeObserver().addOnWindowFocusChangeListener(new C06124());
    ...
    L_0x0012:
        ...
        r5 = com.truck.floter.model.Trip.class;
        r2 = r3.fromJson(r4, r5);	 Catch:{ JSONException -> 0x0077, Exception -> 0x007c }
        r2 = (com.truck.floter.model.Trip) r2;	 Catch:{ JSONException -> 0x0077, Exception -> 0x007c }
    ...
    L_0x004c:
        r3 = com.truck.floter.application.MyApp.getApplication();	 Catch:{ Exception -> 0x007e, JSONException -> 0x0077 }
    ...
    L_0x0060:
        ...
        r4 = com.truck.floter.model.TripStatus.Finished;	 Catch:{ JSONException -> 0x0077, Exception -> 0x007c }
    ...
    L_0x007e:
        ...
        goto L_0x0060;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.truck.floter.fragments.LiveTripsFragment.onJsonObjectResponseReceived(org.json.JSONObject, int):void");
    }
