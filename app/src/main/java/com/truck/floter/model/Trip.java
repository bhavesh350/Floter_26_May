package com.truck.floter.model;
...
public class Trip implements Serializable {
    ...
    public com.truck.floter.model.User getUser() {
        return User;
    }

    public void setUser(com.truck.floter.model.User user) {
        User = user;
    }

    public com.truck.floter.model.Driver getDriver() {
        return Driver;
    }

    public void setDriver(com.truck.floter.model.Driver driver) {
        Driver = driver;
    }
}
